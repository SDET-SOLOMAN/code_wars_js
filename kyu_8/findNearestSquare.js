...
If n is already a perfect square (e.g. n = 144, n = 81, etc.), you need 
to just return n.
...
function nearestSq(n) {
  ...
  let lowerSquare = Math.floor(squareRoot) ** 2;
  let upperSquare = Math.ceil(squareRoot) ** 2;

  return n - lowerSquare > upperSquare - n ? upperSquare : lowerSquare;
}
