...
// To keep the things simple, we'll consider that any "numbered thing" 
// in the string is a drink. Even "1 bear" -> "1 glass of water"; 
...
function hydrate(s) {
    ...
    let water = math === 1 ? "glass" : "glasses";
  
    return `${math} ${water} of water`;
  }
